      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center space-x-6">
            <button className="text-slate-400 hover:text-cyan-400 transition-colors"><Search size={20} strokeWidth={2.5} /></button>
            <button className="text-slate-400 hover:text-purple-400 transition-colors"><Bell size={20} strokeWidth={2.5} /></button>
    ...
    <BrowserRouter>
      <div className="min-h-screen bg-slate-950 text-slate-200 font-sans selection:bg-purple-500/30">
        ...
        <Routes>
          ...
          <Route path="/jadwal" element={<div className="p-20 text-center text-2xl">Halaman Jadwal (Segera Hadir)</div>} />
          <Route path="/trending" element={<div className="p-20 text-center text-2xl">Halaman Trending (Segera Hadir)</div>} />
        </Routes>
      </div>
    </BrowserRouter>
  );
